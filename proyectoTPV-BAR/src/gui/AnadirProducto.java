...
public class AnadirProducto extends JDialog {
	...
	protected JTextField textFieldStock;
	protected JTextField textFieldPrecio;
	protected JComboBox<Iva> comboBoxIva;
	protected JComboBox<Envase> comboBoxEnvase;
	protected JComboBox<TipoBebida> comboBoxTipoBebida;
	protected JComboBox<Corte> comboBoxCorte;
	protected JComboBox<TipoCarne> comboBoxTipoCarne;
	protected JComboBox<TipoPescado> comboBoxTipoPescado;
	protected JTextArea textAreaDescripcion;
	protected JPanel panelPescado;
	protected JPanel panelBebida;
	protected JPanel panelCarne;
	protected JButton btnCrear;
	protected JButton cancelButton;
	protected JTextField textFieldPesoPescado;
	protected JTextField textFieldPesoCarne;
