...
public class Teclado {
	...
	/**
	 * Lee un decimal positivo del teclado
	 * 
	 * @return decimal positivo introducido por el usuario
	 */
	...
	/**
	 * Lee una decimal positivo del teclado
	 * 
	 * @param msj
	 *            mensaje mostrado al usuario
	 * @return decimal positivo introducida por el usuario
	 */
	public static double leerDecimalPositivo(String msj) {
		System.out.println(msj);
		return leerDecimalPositivo();
	}
